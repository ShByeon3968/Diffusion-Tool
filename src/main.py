...
if __name__ == "__main__":
    ...
    # 2. 객체 이미지 생성
    out_image_path = "./output/output_raccoon.png"
    prompt = "a fantasy sword, white background"
    ...
    mv_images.save("./output/output_mvs_raccoon.png")
    plt.imshow(mv_images)
    plt.axis('off')
    plt.show()
    # 4. Instant Mesh 생성
    mesh_gen = MeshGenerator()
    mesh_gen.excute(mv_images,'./output/mesh_raccoon/')

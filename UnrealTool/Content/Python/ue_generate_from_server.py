...
# Cpp로 이전
# def get_last_uid_from_server():
#     try:
#         resp = requests.get("http://localhost:8000/last_uid/")
#         if resp.status_code == 200:
#             return resp.text.strip()
#         else:
#             unreal.log_error(f"[UID] Failed to get last UID: {resp.status_code}")
#             return None
#     except Exception as e:
#         unreal.log_error(f"[UID] Exception: {e}")
#         return None

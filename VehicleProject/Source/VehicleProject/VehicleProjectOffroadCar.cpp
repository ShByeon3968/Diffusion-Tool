...
#include "VehicleProjectOffroadCar.h"
#include "VehicleProjectOffroadWheelFront.h"
#include "VehicleProjectOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

AVehicleProjectOffroadCar::AVehicleProjectOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UVehicleProjectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UVehicleProjectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UVehicleProjectOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UVehicleProjectOffroadWheelRear::StaticClass();

...
#include "VehicleProjectSportsCar.h"
#include "VehicleProjectSportsWheelFront.h"
#include "VehicleProjectSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AVehicleProjectSportsCar::AVehicleProjectSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UVehicleProjectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UVehicleProjectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UVehicleProjectSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UVehicleProjectSportsWheelRear::StaticClass();
